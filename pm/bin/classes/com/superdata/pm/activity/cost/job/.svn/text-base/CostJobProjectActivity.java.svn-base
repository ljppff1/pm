...
public class CostJobProjectActivity extends BaseActivity implements
	...
	public void initView(){
		...
		Map<String, String> mapconfig = SharedPreferencesConfig
				.config(CostJobProjectActivity.this);
	...
	private class ProjectPlanProjectListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			Intent intent = new Intent(CostJobProjectActivity.this,
