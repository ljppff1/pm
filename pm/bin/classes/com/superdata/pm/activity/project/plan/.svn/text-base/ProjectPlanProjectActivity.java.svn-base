 ...
 *
 */
public class ProjectPlanProjectActivity extends BaseActivity implements
		OnClickListener, IXListViewListener {

	private TextView top_title;
	private ImageView btnBack;
	private EditText et_projectplan_pro_search;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.projectplan_project);
	...
	public void initView(){
		...
		et_projectplan_pro_search = (EditText) findViewById(R.id.et_projectplan_pro_search);
			
		btnBack = (ImageView) findViewById(R.id.ll_top_title);
		btnSearch = (ImageButton) findViewById(R.id.btn_projectplan_pro_search);
		...
		Map<String, String> mapconfig = SharedPreferencesConfig
				.config(ProjectPlanProjectActivity.this);
		empId = mapconfig.get(InterfaceConfig.ID);
			
		listView = (XListView) findViewById(R.id.lv_projectplan_pro_list);
		listView.setOnItemClickListener(new ProjectPlanProjectListener());
	...
	private class ProjectPlanProjectListener implements OnItemClickListener{

		@Override
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			Intent intent = new Intent(ProjectPlanProjectActivity.this,
					ProjectPlanPackageActivity.class);
			intent.putExtra("projectId", pProjectList.get(position-1).getId().toString());
	...
	public void onClick(View v) {
		...
		//点击搜索时
		if(v == btnSearch){
			keyWord = et_projectplan_pro_search.getText().toString();
			flag1 = true;
			page = 1;
			initDataSearch();
		}
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null){
				...
				convertView = LayoutInflater.from(getApplicationContext())
						.inflate(R.layout.projectplan_projectitem, null);
				holder.tv_projectplan_pro_item_number = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_number);
				holder.tv_projectplan_pro_item_name = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_name);
				holder.tv_projectplan_pro_item_startdata = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_startdata);
				holder.tv_projectplan_pro_item_enddata = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_enddata);
				holder.tv_projectplan_pro_item_manager = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_manager);
				holder.tv_projectplan_pro_item_completeness = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_completeness);
				holder.tv_projectplan_pro_item_createtime = (TextView) convertView.findViewById(R.id.tv_projectplan_pro_item_createtime);
			...
			holder.tv_projectplan_pro_item_number.setText(pProjectList.get(position).getCode().toString());
			holder.tv_projectplan_pro_item_name.setText(pProjectList.get(position).getName().toString());
			holder.tv_projectplan_pro_item_startdata.setText(pProjectList.get(position).getStartDate().toString());
			holder.tv_projectplan_pro_item_enddata.setText(pProjectList.get(position).getEndDate().toString());
			holder.tv_projectplan_pro_item_manager.setText(pProjectList.get(position).getEmpName().toString());
			holder.tv_projectplan_pro_item_completeness.setText(pProjectList.get(position).getRate().toString()+"%");
			holder.tv_projectplan_pro_item_createtime.setText(pProjectList.get(position).getCreateDate().toString());
		...
		class Holder{
			//项目编号
			TextView tv_projectplan_pro_item_number;
			//项目名称
			TextView tv_projectplan_pro_item_name;
			//开始时间
			TextView tv_projectplan_pro_item_startdata;
			//结束时间
			TextView tv_projectplan_pro_item_enddata;
			//项目经理
			TextView tv_projectplan_pro_item_manager;
			//完成度
			TextView tv_projectplan_pro_item_completeness;
			//立项时间
			TextView tv_projectplan_pro_item_createtime;
		}
