...
public class CostMaterialProjectActivity extends BaseActivity implements
	...
	public void initView(){
		...
		Map<String, String> mapconfig = SharedPreferencesConfig
				.config(CostMaterialProjectActivity.this);
	...
	private class ProjectPlanProjectListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			Intent intent = new Intent(CostMaterialProjectActivity.this,
					CostJobActivity.class);
