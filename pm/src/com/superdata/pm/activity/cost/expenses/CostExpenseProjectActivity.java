 ...
 *
 */
public class CostExpenseProjectActivity extends BaseActivity implements
		OnClickListener, IXListViewListener {

	private TextView top_title;
	private ImageView btnBack;
	private EditText et_expense_pro_search;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.expenses_project);
	...
	public void initView(){
		...
		et_expense_pro_search = (EditText) findViewById(R.id.et_expense_project_pro_search);
			
		btnBack = (ImageView) findViewById(R.id.ll_top_title);
		btnSearch = (ImageButton) findViewById(R.id.btn_expense_project_pro_search);
		...
		Map<String, String> mapconfig = SharedPreferencesConfig
				.config(CostExpenseProjectActivity.this);
		empId = mapconfig.get(InterfaceConfig.ID);
			
		listView = (XListView) findViewById(R.id.lv_expense_project_pro_list);
	...
	private class ProjectPlanProjectListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			Intent intent = new Intent(CostExpenseProjectActivity.this,
					CostExpensesActivity.class);
	...
	public void onClick(View v) {
		...
		//点击搜索时
		if(v == btnSearch){
			keyWord = et_expense_pro_search.getText().toString();
			flag1 = true;
			page = 1;
			initDataSearch();
		}
