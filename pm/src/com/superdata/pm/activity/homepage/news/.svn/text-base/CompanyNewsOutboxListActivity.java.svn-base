...
public class CompanyNewsOutboxListActivity extends BaseActivity implements
	...
	private Handler handler = new Handler(){
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 3:
				onLoad();
				Toast.makeText(CompanyNewsOutboxListActivity.this,
...
//						String receiveId = (String) resultList.getJSONObject(i).get("receiveId");
	...
	public void initView(){
		...
		Map<String, String> mapconfig = SharedPreferencesConfig
				.config(CompanyNewsOutboxListActivity.this);
	...
	private class OutboxListItemClickListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			// 跳转到发件箱消息
			Intent intent = new Intent(CompanyNewsOutboxListActivity.this,
