...
import com.superdata.pm.activity.homepage.news.CompanyNewsInboxActivity.MyAdapter;
import com.superdata.pm.activity.homepage.news.CompanyNewsInboxActivity.MyTask;
 ...
 *
 */
public class CompanyNewsOutBoxActivity extends BaseActivity implements IXListViewListener,
				OnClickListener{
...
//	private Button btnNewMsg;
	...
	//搜索输入框
	private EditText et_companynews_outbox_search;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.companynews_outbox);
	...
	private Handler handler = new Handler(){
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 3:
				onLoad();
				Toast.makeText(CompanyNewsOutBoxActivity.this,
...
//						initData(empId, pageNum+"", pageSize+"", status+"");
						...
						IntentUtils.gotoActivity(CompanyNewsOutBoxActivity.this,
...
//						String receiveId = (String) resultList.getJSONObject(i).get("receiveId");
						...
						iMsg1 = new IMsg(content, receiveName, createDate, msgName, id);
	...
	public void initView(){
		...
		et_companynews_outbox_search = (EditText) findViewById(R.id.et_companynews_outbox_search);
		
		btnBack = (ImageView) findViewById(R.id.ll_top_title);
//		btnSearch = (Button) findViewById(R.id.btn_companynews_outbox_search);
//		btnNewMsg = (Button) findViewById(R.id.btn_companynews_outbox_add);
		btnSelectAll = (Button) findViewById(R.id.btn_companynews_outbox_selectall);
		btnDelete = (Button) findViewById(R.id.btn_companynews_outbox_delete);
		btnSearch = (ImageButton) findViewById(R.id.btn_companynews_outbox_search);
...
//		btnNewMsg.setOnClickListener(this);
		...
		Map<String, String> mapconfig = SharedPreferencesConfig
				.config(CompanyNewsOutBoxActivity.this);
		...
		listView = (XListView) findViewById(R.id.lv_companynews_outbox);
//		listView.setOnItemClickListener(new OutboxListItemClickListener());
	...
	/*private class OutboxListItemClickListener implements OnItemClickListener{

		@Override
		public void onItemClick(AdapterView<?> parent, View view, int position,
				long id) {
			// 跳转到发件箱消息
			Intent intent = new Intent(CompanyNewsOutBoxActivity.this,
					CompanyNewsOutBoxDetailActivity.class);
	...
	public void onClick(View v) {
		...
		// 点击搜索时
		/*if(v == btnSearch){
			keyword = et_companynews_outbox_search.getText().toString();
			flag1 = true;
			pageNum = 1;
			initDataSearch();
...
//				chooseNum = 0;
				...
				chooseNum++;
//				isMap = true;
				/*new AlertDialog.Builder(CompanyNewsOutBoxActivity.this)
				.setTitle("删除消息")
				.setMessage("删除消息后，对应发送给收件人的消息也会相应删除！确定删除选中的消息？")
